...
public class makro_wyniki extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_makro_wyniki);
    ...
    private class AsyncDownloader extends AsyncTask<Object, String, Integer> {
        ...
        private void handleNewRecord(String wynik) {
            TextView textView = (TextView) findViewById(R.id.makroListaWyniki);
        ...
        private int processReceivedData(XmlPullParser xmlData) throws XmlPullParserException, IOException {
            ...
            Log.i(TAG, "Pobrano " + recordsFound + " rekordow.");
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (values.length == 3) {
                ...
                for (int i=0;i<Makro_wskazniki.zaznaczoneWskaznikiNazwa.length; i++) {

                    if (nazwaWskaznika.equalsIgnoreCase(Makro_wskazniki.zaznaczoneWskaznikiNazwa[i])){
