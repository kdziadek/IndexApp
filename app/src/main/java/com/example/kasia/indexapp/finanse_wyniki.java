...
public class finanse_wyniki extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finanse_wyniki);

        Log.i(TAG, "Lacze z serwerem...");
    ...
    private class AsyncDownloader extends AsyncTask<Object, String, Integer> {
        ...
        private void handleNewRecord(String wynik) {
            TextView textView = (TextView) findViewById(R.id.finanseListaWyniki);
            textView.setText(wynik);
        }

        @Override
        protected Integer doInBackground (Object...arg0){
            XmlPullParser receivedData = tryDownloadingXmlData(); //uruchomienie parsera
            int recordsFound = tryParsingXmlData(receivedData); //liczba znalezionych rekordow
        ...
        private int processReceivedData(XmlPullParser xmlData) throws XmlPullParserException, IOException {
            int recordsFound = 0; //liczba znalezionych rekordow
            String text = ""; //wartosc parsowanego znacznika
            String wartoscWskaznika = ""; // <wartosc>
            String nazwaWskaznika = ""; // <nazwa>
            String dataWskaznika = ""; // <data>
            ...
            Log.i(TAG, "Znaleziono " + recordsFound + " rekordow.");
        ...
        protected void onProgressUpdate(String... values) {
            if (values.length == 0) {
                Log.i(TAG, "Nie pobrano zadnych danych");
            }
            if (values.length == 3) {
                ...
                //zapisanie do zmiennej wynik zawartosci jednego wskaznika
				for (int i=0;i<Finanse_wskazniki.zaznaczoneWskaznikiNazwa.length; i++) {
                    if (nazwaWskaznika.equalsIgnoreCase(Finanse_wskazniki.zaznaczoneWskaznikiNazwa[i])){
